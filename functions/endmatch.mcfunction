...
execute at @p if score "§o§7Spieler" matchvars matches 1 run titleraw @p title {"rawtext":[{"text":"§l§6Training beendet"}]}
execute at @p if score "§o§7Spieler" matchvars matches 1 run scoreboard objectives remove playermatch 
execute at @a if score @p playermatch = "§o§7Sieger" matchvars run titleraw @p title {"rawtext":[{"text":"§l§2Matchsieg!"}]} 
execute at @a if score @p playermatch < "§o§7Sieger" matchvars run titleraw @p title {"rawtext":[{"text":"§l§4Niederlage!"}]}
