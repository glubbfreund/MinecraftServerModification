execute at @a[r=4] if score "§o§7Match" matchvars matches 1 run title @a actionbar §l§4Es läuft bereits ein Match!
...
execute unless score "§o§7Match" matchvars matches 1 run scoreboard players add "§o§7Pfeile gesamt" playermatch 0
